...
const Auth = () => {
  ...
  const handleOAuthSignIn = async (provider: 'google' | 'linkedin_oidc', mode: "signin" | "signup") => {
    setIsLoading(true);
    ...
    try {
      ...
      toast({
        variant: "destructive",
        title: "Authentication Error",
        description: error.message || "An error occurred during OAuth authentication.",
      });
      setIsLoading(false);
    }
  };
              ...
              <TabsContent value="signin" className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Button 
                    variant="outline" 
                    className="w-full"
                    onClick={() => handleOAuthSignIn('google', 'signin')}
                    disabled={isLoading}
                  >
                  ...
                  <Button 
                    variant="outline" 
                    className="w-full"
                    onClick={() => handleOAuthSignIn('linkedin_oidc', 'signin')}
                    disabled={isLoading}
                  >
              ...
              <TabsContent value="signup" className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <Button 
                    variant="outline" 
                    className="w-full"
                    onClick={() => handleOAuthSignIn('linkedin_oidc', 'signup')}
                    disabled={isLoading}
                  >
                    <Mail className="mr-2 h-4 w-4" />
                    LinkedIn
